...
macro(utils_check_std_c)
  ...
  if(CMAKE_C_COMPILER_ID STREQUAL "MSVC")
    check_c_compiler_flag("/std:c${ARG_STANDARD}"
                          COMPILE_HAVE_STD_C${ARG_STANDARD})
  else()
    check_c_compiler_flag("-std=c${ARG_STANDARD}"
                          COMPILE_HAVE_STD_C${ARG_STANDARD})
  endif()

  set(${ARG_RESULT} ${COMPILE_HAVE_STD_C${ARG_STANDARD}})
...
macro(utils_check_std_cxx)
  ...
  if(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
    check_cxx_compiler_flag("/std:c++${ARG_STANDARD}"
                            COMPILE_HAVE_STD_CXX${ARG_STANDARD})
  else()
    check_cxx_compiler_flag("-std=c++${ARG_STANDARD}"
                            COMPILE_HAVE_STD_CXX${ARG_STANDARD})
  endif()

  set(${ARG_RESULT} ${COMPILE_HAVE_STD_CXX${ARG_STANDARD}})
...
function(utils_set_highest_c_standard TARGET)
  ...
  foreach(std ${standards})
    ...
    if(NOT CMAKE_C_COMPILER_ID STREQUAL "MSVC")
      check_c_compiler_flag("-std=gnu${std}" COMPILE_HAVE_STD_GNU${std})
      if(COMPILE_HAVE_STD_GNU${std})
        set(find_flag ON)
...
function(utils_set_highest_cxx_standard TARGET)
  ...
  foreach(std ${standards})
    ...
    if(NOT CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
      check_cxx_compiler_flag("-std=gnu++${std}" COMPILE_HAVE_STD_GNUXX${std})
      if(COMPILE_HAVE_STD_GNUXX${std})
        set(find_flag ON)
