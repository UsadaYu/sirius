 ...
 */
#ifndef force_inline
#  if sirius_gcc_version_check_at_least(3, 4) || defined(__clang__)
 ...
 */
#ifndef weak_symbol
#  if sirius_gcc_version_check_at_least(3, 0) || \
    sirius_clang_version_check_at_least(3, 0)
