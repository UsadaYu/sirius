...
#    define ss_cpu_pause() __asm__ volatile("pause" ::: "memory")
#  elif defined(__aarch64__) || defined(__arm__)
#    if defined(__aarch64__) || (defined(__ARM_ARCH) && __ARM_ARCH >= 7)
#      define ss_cpu_pause() __asm__ volatile("yield" ::: "memory")
#    else
#      define ss_cpu_pause() __asm__ volatile("nop" ::: "memory")
#    endif
#  elif defined(__powerpc__) || defined(__ppc__)
#    define ss_cpu_pause() __asm__ volatile("or 27,27,27" ::: "memory")
...
#  endif
#  define ss_os_yield() SwitchToThread()
#elif defined(__linux__) || defined(__APPLE__) || defined(__unix__) || \
  defined(__posix__)
#  include <sched.h>
#  define ss_os_yield() sched_yield()
#elif (defined(__cplusplus) && __cplusplus >= 201103L) || \
  (defined(_MSVC_LANG) && _MSVC_LANG >= 201103L)
#  include <thread>
#  define ss_os_yield() std::this_thread::yield()
#else
#  define ss_os_yield() \
    do { \
    } while (0)
